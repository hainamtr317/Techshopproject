...
function OrdersCard({ data }) {
  return (
    <div
      className="mr-50 grid grid-cols-9 w-full border-b-[1px] h-[75px]"
      key={data.id}
    >
      <input
        type="checkbox"
      ...
      <h4 className="my-auto ml-[-100px] capitalize text-[0.6rem] sm:text-[0.7rem] md:text-[0.8rem] lg:text-[1rem] text-[#0066b2]">
        {data.phone}
      </h4>
      <div className="my-auto ml-[10px] capitalize text-[0.6rem] sm:text-[0.7rem] md:text-[0.8rem] lg:text-[1rem] text-[#0066b2] flex items-center">
        <span className="text-[#00563B] bg-[#17B169] p-2 rounded-xl font-bold">
          {data.status}
        </span>
      </div>
      <h4 className="my-auto ml-[-100px] capitalize text-[0.7rem] text-[#0066b2] flex items-center">
        <OrdersProductDropList options={data.products} />
      </h4>
      <h4 className="my-auto ml-[180px] capitalize text-[0.6rem] sm:text-[0.7rem] md:text-[0.8rem] lg:text-[1rem] text-[#0066b2]">
        $ {data.totalSales}
      </h4>
    </div>
  );
